...
import type { ImageEditorActionBox, ImageEditorOptions, IFileBrowserDataProvider, IPanel, IDialog } from 'jodit/types';
 ...
 *
 */
export declare class ImageEditor extends ViewComponent<IPanel> {
    /** @override */
    className(): string;
 ...
 * Open Image Editor
 */
export declare function openImageEditor(this: IPanel & {
